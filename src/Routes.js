...
import CourseAnnouncement from "./pages/CourseAnnouncement";
import Comment from "./pages/CourseAnnouncement/comments";
...
const renderRoutes = () => (
  <Container maxWidth="xs" style={{ margin: "auto", padding: 0 }}>
    <Switch>
      ...
      <Route path="/mycourses/:coursename/announcement" exact component={CourseAnnouncement} />
      <Route path="/mycourses/:coursename/announcement/:id/comments" exact component={Comment} />
      <Route path="/terms-and-conditions" exact component={Terms} />
