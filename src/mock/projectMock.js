  ...
  todos: [
    {
      ...
      deadline: moment().subtract(2, "days").toDate().getTime(),
      done: false,
    },
    {
    ...
    },
    {
      ...
      deadline: moment().add(7, "days").toDate().getTime(),
      done: true,
    },
  ],
});
